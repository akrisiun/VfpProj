...
namespace VfpLanguage
{
    ...
    {
        public const string guidVfpLanguagePkgString = Vsix.Id; // "f4ab1e64-5555-4f06-bad9-bf414f4b3cc2"; // bbb";
        ...
        //<Button guid = "guidVfpLanguageCmdSet" id="cmdExecuteCmd" priority="0x0700" type="Button">
