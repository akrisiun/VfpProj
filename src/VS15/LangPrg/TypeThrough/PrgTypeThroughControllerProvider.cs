...
namespace VfpLanguage
{
    ...
    internal class PrgTypeThroughControllerProvider : IIntellisenseControllerProvider
    {
        public IIntellisenseController TryCreateIntellisenseController(ITextView view, IList<ITextBuffer> subjectBuffers)
        {
            return new PrgTypeThroughController(view, subjectBuffers);
        }
    }

    internal class PrgTypeThroughController1 : TypeThroughController
    {
        public PrgTypeThroughController1(ITextView textView, IList<ITextBuffer> subjectBuffers)
