...
*Revision 1.6  2005/03/29 06:39:06  andriusk *Agen, AXSP tables H:\ECOM" usecfg.xml
*Revision 1.5  2005/03/04 16:43:25  andriusk *Less debugout (minimal)
*Revision 1.4  2005/02/18 09:21:49  andriusk *KeyPress .oActive = .ActiveControl
*Revision 1.3  2005/02/03 08:53:09  andriusk *LObj RightClick, some fixes
*Revision 1.2  2004/11/29 12:30:59  andriusk *uRetVal fixes, L_Save/Restore Pos funcs

#DEFINE ASSERT_DEB  ASSERT .F. MESSAGE 
* #DEFINE VFPLIB_PATH D:\Vfplib
#DEFINE VFPLIB_PATH d:\webstack\VSIX\VfpProj\vfp\PrjView
...
*   #DEFINE LIB_PATH D:\Vfplib\Sys\
    #DEFINE LIB_PATH d:\webstack\VSIX\VfpProj\vfp\PrjView\
#ENDIF 
...
WITH tObject 
   ...
   ENDIF 
    ...
    IF VERSION(5) >= 800 && VVFP8_VERSION 
