...
// filename of FLL
	#define FLLFILENAME "vfpbind.fll"
/*#ifndef _DEBUG
	#define FLLFILENAME "vfpbind.fll"
#else
	#define FLLFILENAME "vfpbindd.fll"
#endif
*/
...
#define RAISEERROR(nErrorNo)				_Error(nErrorNo)
#define RAISEERROREX(nErrorNo)				RetVFP2CError(nErrorNo)
